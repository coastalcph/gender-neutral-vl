#!/bin/bash
#SBATCH --job-name=albef_14m_coco_neutral-bias
#SBATCH --ntasks=1 --cpus-per-task=1
#SBATCH --mem=30G
#SBATCH -p gpu --gres=gpu:1
#SBATCH --time=0-06:00:00
#SBATCH --output=eval_bias_albef_14m_coco_neutral.out
#SBATCH --error=eval_bias_albef_14m_coco_neutral.err
...
ckpt=${OUTS_DIR}/Pretrain_COCO_neutral/albef_14m/checkpoint_00.pth
