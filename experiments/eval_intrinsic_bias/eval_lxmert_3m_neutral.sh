#!/bin/bash
#SBATCH --job-name=lxmert_3m_neutral-bias
#SBATCH --ntasks=1 --cpus-per-task=1
#SBATCH --mem=30G
#SBATCH -p gpu --gres=gpu:1
#SBATCH --time=0-06:00:00
#SBATCH --output=eval_bias_lxmert_3m_neutral.out
#SBATCH --error=eval_bias_lxmert_3m_neutral.err
...
split=val
configs=${CODE_DIR}/LXMERT/volta/config/lxmert.json
