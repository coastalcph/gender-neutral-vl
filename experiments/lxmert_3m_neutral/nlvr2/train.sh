#!/bin/bash
#SBATCH --job-name=nlvr_lxmert3m_neutral
...
cd $CODE_DIR
# Hyperparms: https://github.com/e-bug/volta/blob/main/examples/ctrl_lxmert/nlvr2/train.sh
python train_task.py \
	...
	--weight_decay 0.0001 --warmup_proportion 0.1 --clip_grad_norm 1.0 \
	--output_dir ${output} \
	--logdir ${logs} \
	--use_wandb \
