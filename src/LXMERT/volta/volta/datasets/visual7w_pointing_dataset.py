...
from volta.tools.refer.refer import REFER
...
class Visual7wPointingDataset(Dataset):
    ...
    def _load_annotations(self, clean_datasets):
        ...
        with open(os.path.join(self.dataroot, "dataset.json"), "rb") as f:
    ...
    def __getitem__(self, index):
        ...
        print(image_id, ref_box, multiple_choice_idx)
        ...
        (
            ...
            gt_boxes,
            gt_boxes_ori,
        ) = self._gt_image_features_reader[str(image_id)]
