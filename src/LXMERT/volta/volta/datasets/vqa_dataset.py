...
LXMERT_SPLIT_MAP = {
    # "train": "trainlxmert",  # lxmert splits
    # "val": "minival",  # lxmert splits
    "train": "train",
    "val": "val",
    "test": "test"
}
...
def _load_dataset(dataroot, name):
    ...
    name: 'train', 'val', 'trainval', 'minsval', 'trainlxmert', 'minival'
    """
    if name == "train" or name == "trainlxmert" or name == "val" or name == "minival":
        ...
        question_path_train = os.path.join(dataroot, "questions", "v2_OpenEnded_mscoco_%s2014_questions.json" % "train")
        ...
        question_path_val = os.path.join(dataroot, "questions", "v2_OpenEnded_mscoco_%s2014_questions.json" % "val")
        ...
        question_path_test = os.path.join(dataroot, "questions", "v2_OpenEnded_mscoco_%s2015_questions.json" % "test")
...
class VQAClassificationDataset(Dataset):
    def __init__(
        ...
        super().__init__()
        self.split = LXMERT_SPLIT_MAP[split]
        ans2label_path = os.path.join(dataroot, "annotations", "trainval_ans2label.json")
        label2ans_path = os.path.join(dataroot, "annotations", "trainval_label2ans.json")
        # self.ans2label = cPickle.load(open(ans2label_path, "rb"))
        # self.label2ans = cPickle.load(open(label2ans_path, "rb"))
        self.ans2label = json.load(open(ans2label_path, "r", encoding="utf8"))
        self.label2ans = json.load(open(label2ans_path, "r", encoding="utf8"))
        ...
        if not os.path.exists(cache_path):
            self.entries = _load_dataset(dataroot, LXMERT_SPLIT_MAP[split])
